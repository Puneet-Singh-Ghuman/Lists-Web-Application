 ...
 /**
  ...
  /**
    ...
    private function sendVerificationEmail($email, $ver)
    {
        ...
        $headers = <<<MESSAGE
From: Colored Lists <donotreplyclists@gmail.com>
...
Activate your account: http://col-lists.com/accountverify.php?v=$ver&e=$e
...
http://col-lists.com/resetpassword.php?v=$ver&e=$e
